You will need to open the matlab file(.m) so you can insert the values of the circuit.The you can see the bode diagramm the transfer function and root locus diagram. Then
